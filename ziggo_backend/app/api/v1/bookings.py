...
async def _booking_to_response(db: AsyncSession, booking: Booking) -> BookingResponse:
    ...
    return BookingResponse(
        ...
        requested_drop_lat=float(b.requested_drop_lat) if b.requested_drop_lat is not None else None,
        requested_drop_lng=float(b.requested_drop_lng) if b.requested_drop_lng is not None else None,
        requested_drop_address=b.requested_drop_address,
...
async def create_booking(
    ...
    booking = Booking(
        ...
        requested_drop_lat=Decimal(str(req.drop_lat)),
        requested_drop_lng=Decimal(str(req.drop_lng)),
        requested_drop_address=req.drop_address,
