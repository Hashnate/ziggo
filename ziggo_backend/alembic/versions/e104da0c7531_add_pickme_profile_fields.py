...
def upgrade() -> None:
    ...
    with op.batch_alter_table('bookings', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_bookings_corporate_id', 'corporate_accounts', ['corporate_id'], ['id'])
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('bookings', schema=None) as batch_op:
        batch_op.drop_constraint('fk_bookings_corporate_id', type_='foreignkey')
