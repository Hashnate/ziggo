...
class _RestaurantOrderDetailScreenState
  ...
  Future<void> _accept() async {
    ...
    _toast('Order accepted â€” start preparing');
  }
  ...
  Future<void> _markPreparing() async {
    ...
    _toast('Kitchen has started â€” tap Mark Ready once packed');
  }
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text(
                  'Pick a reason â€” customer is refunded automatically if they paid by wallet.',
...
class _HeroStatus extends StatelessWidget {
  ...
  String _hint(String s) {
    switch (s) {
      ...
      case 'delivered':
        return 'Completed â€” thanks for cooking with Ziggo';
      case 'cancelled':
