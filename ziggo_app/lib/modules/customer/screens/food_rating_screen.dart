...
// Food-order colour tokens (match food_tracking_screen.dart)
...
class FoodRatingScreen extends StatefulWidget {
  ...
  const FoodRatingScreen({super.key, required this.orderId, required this.orderRef});

  @override
  State<FoodRatingScreen> createState() => _FoodRatingScreenState();
}
...
class _FoodRatingScreenState extends State<FoodRatingScreen>
  ...
  Future<void> _submit() async {
    ...
    bool ok = false;
    try {
      ok = await context.read<FoodProvider>().rateOrder(
            widget.orderId,
            _stars,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Spacer(),
                        // Submit button styled in food orange
                        SizedBox(
                          height: 56,
