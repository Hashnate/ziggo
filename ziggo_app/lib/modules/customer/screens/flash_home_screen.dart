    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            children: [
              Icon(icon, size: 20, color: sel ? AppColors.primary : AppColors.textPrimary),
              const SizedBox(width: 12),
              Text(
                label,
                style: TextStyle(fontWeight: FontWeight.w900, color: sel ? Colors.white : AppColors.textPrimary),
              ),
              if (sel) ...[
                const Spacer(),
