...
class MarketVendorDailyReportScreen extends StatefulWidget {
  final String date;

  const MarketVendorDailyReportScreen({
    super.key,
    required this.date,
  });

  @override
  State<MarketVendorDailyReportScreen> createState() =>
      _MarketVendorDailyReportScreenState();
}

class _MarketVendorDailyReportScreenState
    extends State<MarketVendorDailyReportScreen> {
  bool _loading = true;
